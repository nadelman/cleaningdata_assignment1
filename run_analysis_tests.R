...
test_create_data_set <- function() {
  ...
  checkEquals(81, length(colnames(output))
  ...
  checkequals(colnames(output)[48], "fBodyAcc-meanFreq()-X")
  checkequals(colnames(output)[49], "fBodyAcc-meanFreq()-Y")
  checkequals(colnames(output)[50], "fBodyAcc-meanFreq()-Z")
  ...
  checkequals(colnames(output)[57], "fBodyAccJerk-meanFreq()-X")
  checkequals(colnames(output)[58], "fBodyAccJerk-meanFreq()-Y")
  checkequals(colnames(output)[59], "fBodyAccJerk-meanFreq()-Z")
  checkequals(colnames(output)[60], "fBodyGyro-mean()-X ")
  checkequals(colnames(output)[61], "fBodyGyro-mean()-Y")
  checkequals(colnames(output)[62], "fBodyGyro-mean()-Z")
  checkequals(colnames(output)[63], "fBodyGyro-std()-X")
  checkequals(colnames(output)[64], "fBodyGyro-std()-Y")
  checkequals(colnames(output)[65], "fBodyGyro-std()-Z")
  checkequals(colnames(output)[66], "fBodyGyro-meanFreq()-X")
  checkequals(colnames(output)[67], "fBodyGyro-meanFreq()-Y")
  checkequals(colnames(output)[68], "fBodyGyro-meanFreq()-Z")
  checkequals(colnames(output)[69], "fBodyAccMag-mean()")
  checkequals(colnames(output)[70], "fBodyAccMag-std()")
  checkequals(colnames(output)[71], "fBodyAccMag-meanFreq()")
  checkequals(colnames(output)[72], "fBodyBodyAccJerkMag-mean()")
  checkequals(colnames(output)[73], "fBodyBodyAccJerkMag-std()")
  checkequals(colnames(output)[74], "fBodyBodyAccJerkMag-meanFreq()")
  checkequals(colnames(output)[75], "fBodyBodyGyroMag-mean()")
  checkequals(colnames(output)[76], "fBodyBodyGyroMag-std()")
  checkequals(colnames(output)[77], "fBodyBodyGyroMag-meanFreq()")
  checkequals(colnames(output)[78], "fBodyBodyGyroJerkMag-mean()")
  checkequals(colnames(output)[79], "fBodyBodyGyroJerkMag-std()")
  checkequals(colnames(output)[80], "fBodyBodyGyroJerkMag-meanFreq()")
  checkequals(colnames(output)[81], "class")      
